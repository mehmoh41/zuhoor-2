    ...
    ?>
        <?php
            if (have_posts()) :
                ...
                <div class="container">
                    <?php 
                        if(is_home() && !is_front_page()) {
                            ?>
                          <div class="border-b my-10 flex justify-between text-sm max-w-screen-xl">
                            <div class="text-blue-600 flex items-center pb-2 pr-2 border-b-2 border-blue-600 uppercase">
                              <svg class="h-8 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.005 455.005" style="enable-background:new 0 0 455.005 455.005;" xml:space="preserve">
                              <g>
                                <path d="M446.158,267.615c-5.622-3.103-12.756-2.421-19.574,1.871l-125.947,79.309c-3.505,2.208-4.557,6.838-2.35,10.343
                                  ...
                                  C455.004,277.119,451.78,270.719,446.158,267.615z"></path>
                                <path d="M353.664,232.676c2.492,0,4.928-1.241,6.354-3.504c2.207-3.505,1.155-8.136-2.35-10.343l-173.3-109.126
                                  ...
                                  C350.916,232.303,352.298,232.676,353.664,232.676z"></path>
                                <path d="M323.68,252.58c2.497,0,4.938-1.246,6.361-3.517c2.201-3.509,1.14-8.138-2.37-10.338L254.46,192.82
                                  ...
                                  C320.941,252.21,322.318,252.58,323.68,252.58z"></path>
                                <path d="M223.903,212.559c-3.513-2.194-8.14-1.124-10.334,2.39c-2.194,3.514-1.124,8.14,2.39,10.334l73.773,46.062
                                  c1.236,0.771,2.608,1.139,3.965,1.139c2.501,0,4.947-1.251,6.369-3.529c2.194-3.514,1.124-8.14-2.39-10.334L223.903,212.559z"></path>
                                <path d="M145.209,129.33l-62.33,39.254c-2.187,1.377-3.511,3.783-3.503,6.368s1.345,4.983,3.54,6.348l74.335,46.219
                                  ...
                                  c-0.018-2.563-1.344-4.94-3.516-6.302l-73.218-45.909C150.749,127.792,147.647,127.795,145.209,129.33z"></path>
                                <path d="M270.089,288.846c2.187-3.518,1.109-8.142-2.409-10.329l-74.337-46.221c-3.518-2.188-8.143-1.109-10.329,2.409
                                  ...
                                  C266.219,292.387,268.669,291.131,270.089,288.846z"></path>
                                <path d="M53.527,192.864c-2.187,3.518-1.109,8.142,2.409,10.329l183.478,114.081c1.232,0.767,2.601,1.132,3.953,1.132
                                  ...
                                  C60.338,188.266,55.714,189.346,53.527,192.864z"></path>
                              </g>
                              </svg>
                              <span class="font-semibold inline-block text-3xl"><?php single_post_title()?></span>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" id="ajax-posts">
                ...
                <!-- load more posts -->
                <a id="more_posts" class="block w-32 my-8 mx-auto cursor-pointer bg-indigo-500 hover:bg-indigo-800 text-white px-3 py-2 text-center">Load More
                  <svg class="inline-block w-4 h-4 fill-current text-white"version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
